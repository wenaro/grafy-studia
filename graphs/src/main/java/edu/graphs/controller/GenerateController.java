...
public class GenerateController {
    ...
    public String generate(final Model model) {
        addModelAttributes(model, new Input(), new Form(), null);
        return "generate";
    }
    ...
    public String submitInput(final Model model, @ModelAttribute final Input input) {
        ...
        addModelAttributes(model, input, new Form(), graphService.checkIfEulerCycleExist(graph));
    ...
    public String clearGraph(final Model model, @ModelAttribute final Input input) {
        graph = new Graph();
        addModelAttributes(model, input, new Form(),null);
        return "generate";
    }
